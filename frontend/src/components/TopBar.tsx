          ...
          <div className="flex items-start gap-2">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline-block text-[9px] font-bold tracking-wide px-1.5 py-0.5 rounded-md bg-black/5 text-gray-500 border border-gray-200/40">v1.2</span>
              </div>
