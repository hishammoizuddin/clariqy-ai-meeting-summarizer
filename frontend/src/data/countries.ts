/**
 * Comprehensive world country list — 249 entries.
 * dialCode is the bare E.164 country-calling code (no sub-codes).
...
export const COUNTRIES: CountryEntry[] = [
  ...
  { name: 'British Virgin Islands', dialCode: '+1' },
  ...
  { name: 'Cayman Islands', dialCode: '+1' },
  ...
  { name: 'Congo (Democratic Republic)', dialCode: '+243' },
  ...
  { name: 'Northern Mariana Islands', dialCode: '+1' },
  ...
  { name: 'Turks and Caicos Islands', dialCode: '+1' },
  ...
  { name: 'United States Virgin Islands', dialCode: '+1' },
...
/** Deduplicated, sorted list of all dial codes for use in a <select>. */
export const DIAL_CODE_OPTIONS: CountryEntry[] = COUNTRIES

/** Plain country name list for autocomplete / datalist. */
